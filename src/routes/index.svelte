<script>
	import AuthNavbar from '$lib/Navbars/AuthNavbar.svelte';
	import Footer from '$lib/Footers/Footer.svelte';
	import LandingPageCard from '$lib/Cards/LandingPageCard.svelte';
	import TeamMember from '$lib/Landing/TeamMember.svelte';
</script>
		...
		<section class="pb-20 bg-blueGray-200 -mt-24">
			<div class="container mx-auto px-4">
				<div class="flex flex-wrap">
					...
					<LandingPageCard
						icon="fas fa-retweet"
						iconBackgroundColor="bg-lightBlue-400"
					...
					<LandingPageCard
						...
						iconBackgroundColor="bg-emerald-400"
