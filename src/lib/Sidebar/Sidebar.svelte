<script>
	...
	import NotificationDropdown from '$lib/Dropdowns/NotificationDropdown.svelte';
	import UserDropdown from '$lib/Dropdowns/UserDropdown.svelte';
			...
			<ul class="md:flex-col md:min-w-full flex flex-col list-none">
				<li class="items-center">
					<a
						...
						class="text-xs uppercase py-3 font-bold block {$page.path === '/admin/dashboard'
							? 'text-red-500 hover:text-red-600'
							: 'text-blueGray-700 hover:text-blueGray-500'}"
					>
						<i
							class="fas fa-tv mr-2 text-sm {$page.path === '/admin/dashboard'
								? 'opacity-75'
								: 'text-blueGray-300'}"
						/>
						Dashboard
				...
				<li class="items-center">
					<a
						href="/admin/settings"
						class="text-xs uppercase py-3 font-bold block {$page.path?.indexOf(
							'/admin/settings'
						) !== -1
							? 'text-red-500 hover:text-red-600'
							: 'text-blueGray-700 hover:text-blueGray-500'}"
					>
						<i
							class="fas fa-tools mr-2 text-sm {$page.path?.indexOf('/admin/settings') !== -1
								? 'opacity-75'
								: 'text-blueGray-300'}"
						/>
						Settings
				...
				<li class="items-center">
					<a
						href="/admin/tables"
						class="text-xs uppercase py-3 font-bold block {$page.path?.indexOf('/admin/tables') !==
						-1
							? 'text-red-500 hover:text-red-600'
							: 'text-blueGray-700 hover:text-blueGray-500'}"
					>
						<i
							class="fas fa-table mr-2 text-sm {$page.path?.indexOf('/admin/tables') !== -1
								? 'opacity-75'
								: 'text-blueGray-300'}"
						/>
						Tables
				...
				<li class="items-center">
					<a
						href="/admin/maps"
						class="text-xs uppercase py-3 font-bold block {$page.path?.indexOf('/admin/maps') !== -1
							? 'text-red-500 hover:text-red-600'
							: 'text-blueGray-700 hover:text-blueGray-500'}"
					>
						<i
							class="fas fa-map-marked mr-2 text-sm {$page.path?.indexOf('/admin/maps') !== -1
								? 'opacity-75'
								: 'text-blueGray-300'}"
						/>
						Maps
